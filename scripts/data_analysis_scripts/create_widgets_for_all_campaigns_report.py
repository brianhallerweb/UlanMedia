...
with open(f'/home/bsh/Documents/UlanMedia/data/widgets_for_all_campaigns/{date_range}_widgets_for_all_campaigns_dataset.json', 'r') as file:
     data = json.load(file)
...
conditions_args = [sys.argv[3], sys.argv[4]]
