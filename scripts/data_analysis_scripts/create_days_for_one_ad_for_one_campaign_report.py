...
with open(f'{os.environ.get("ULANMEDIAAPP")}/data/days_for_one_ad_for_one_campaign/{ad_image}_{campaign_id}_days_for_one_ad_for_one_campaign_dataset.json', 'r') as file:
    data = json.load(file)
