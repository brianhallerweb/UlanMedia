...
with open(f'{os.environ.get("ULANMEDIAAPP")}/data/days_for_one_country_for_all_campaigns/{country_name}_days_for_one_country_for_all_campaigns_dataset.json', 'r') as file:
    data = json.load(file)
