...
with open(f'{os.environ.get("ULANMEDIAAPP")}/data/months_for_one_offer_for_all_campaigns/{offer_name}_months_for_one_offer_for_all_campaigns_dataset.json', 'r') as file:
    data = json.load(file)
