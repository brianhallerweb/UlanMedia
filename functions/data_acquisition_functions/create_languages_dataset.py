...
def create_languages_dataset(token, start_date, end_date):
    try:
        ...
        with open(f"{os.environ.get('ULANMEDIAAPP')}/data/languages/oneeighty_languages_dataset.json", "w") as file:
