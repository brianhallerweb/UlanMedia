...
def create_months_for_one_c_widget_for_all_campaigns_dataset(token, start_date, end_date, c_widget_id):
    try:
        ...
        with open(f"{os.environ.get('ULANMEDIAAPP')}/data/months_for_one_c_widget_for_all_campaigns/{c_widget_id}_months_for_one_c_widget_for_all_campaigns_dataset.json", "w") as file:
        ...
        send_email("brianshaller@gmail.com", "Failed - create_months_for_one_c_widget_for_all_campaigns_dataset()", "Failed - create_months_for_one_c_widget_for_all_campaigns_dataset()")
        sys.exit()
