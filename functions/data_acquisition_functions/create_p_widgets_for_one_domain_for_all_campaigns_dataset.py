...
def create_p_widgets_for_one_domain_for_all_campaigns_dataset(date_range, domain):
    try:
        ...
        send_email("brianshaller@gmail.com", "Failed - create_p_widgets_for_one_domain_for_all_campaigns_dataset()", "Failed - create_p_widgets_for_one_domain_for_all_campaigns_dataset()")
        sys.exit()
