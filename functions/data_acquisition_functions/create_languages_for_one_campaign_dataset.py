...
def create_languages_for_one_campaign_dataset(vol_id):
    ...
    with open(f"../../data/languages_for_one_campaign/{vol_id}_languages_for_one_campaign_dataset.json", "w") as file:
