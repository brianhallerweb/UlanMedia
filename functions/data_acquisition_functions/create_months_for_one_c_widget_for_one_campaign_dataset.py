...
def create_months_for_one_c_widget_for_one_campaign_dataset(token, start_date, end_date, c_widget_id, campaign_id):
    try:
        ...
        send_email("brianshaller@gmail.com", "Failed - create_months_for_one_c_widget_for_one_campaign_dataset()", "Failed - create_months_for_one_c_widget_for_one_campaign_dataset(()")
        sys.exit()
