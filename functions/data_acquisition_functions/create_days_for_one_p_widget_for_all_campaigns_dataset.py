...
def create_days_for_one_p_widget_for_all_campaigns_dataset(token, start_date, end_date, p_widget_id):
    try:
        ...
        send_email("brianshaller@gmail.com", "Failed - create_days_for_one_p_widget_for_all_campaigns_dataset()", "Failed - create_days_for_one_p_widget_for_all_campaigns_dataset()")
        sys.exit()
