...
def create_days_for_one_offer_for_all_campaigns_dataset(token, start_date,
    ...
    try:
        ...
        send_email("brianshaller@gmail.com", "Failed - create_days_for_one_offer_for_all_campaigns_dataset()", "Failed - create_days_for_one_offer_for_all_campaigns_dataset()")
        sys.exit()
