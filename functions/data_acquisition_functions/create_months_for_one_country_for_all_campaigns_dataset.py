...
def create_months_for_one_country_for_all_campaigns_dataset(token, start_date, end_date, country_name):
    try:
        ...
        send_email("brianshaller@gmail.com", "Failed - create_months_for_one_country_for_all_campaigns_dataset()", "Failed - create_months_for_one_country_for_all_campaigns_dataset()")
        sys.exit()
