...
def create_c_widgets_for_one_p_widget_for_one_campaign_dataset(vol_id, p_widget, date_range, max_rec_bid):
    try:
        ...
        c_widgets_for_one_p_widget_for_one_campaign["metadata"]["mgid_start_date"] = json_file["metadata"]["mgid_start_date"]
        c_widgets_for_one_p_widget_for_one_campaign["metadata"]["mgid_end_date"] = json_file["metadata"]["mgid_end_date"] 
        c_widgets_for_one_p_widget_for_one_campaign["metadata"]["vol_start_date"] = json_file["metadata"]["vol_start_date"]
        c_widgets_for_one_p_widget_for_one_campaign["metadata"]["vol_end_date"] = json_file["metadata"]["vol_end_date"]
        ...
        for c_widget in data:
            if c_widget.startswith(p_widget):
                for campaign in data[c_widget]["for_each_campaign"]:
                    if campaign["vol_id"] == vol_id:
                        ...
                        c_widgets_for_one_p_widget_for_one_campaign["data"].append(campaign)

        for c_widget in c_widgets_for_one_p_widget_for_one_campaign["data"]:
        ...
        send_email("brianshaller@gmail.com", "Failed - create_c_widgets_for_one_p_widget_for_one_campaign_dataset()", "Failed - create_c_widgets_for_one_p_widget_for_one_campaign_dataset()")
        sys.exit()
