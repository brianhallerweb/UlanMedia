...
def exclude_campaign_for_one_c_widget(token, client_id, widget_id, campaign_id):
    ...
    if res.status_code == 401:
        ...
        return exclude_campaign_for_one_c_widget(mgid_token, client_id, widget_id, campaign_id)
