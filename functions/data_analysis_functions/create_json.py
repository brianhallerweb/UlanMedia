...
def create_json(data, output_name):
    ...
    json_final_result = json.dumps(final_result[["name", "clicks", "cost", "revenue", "profit", "leads",
        "lead_cpa", "max_lead_cpa", "sales",
        "sale_cpa","max_sale_cpa","epc", "c1", "c2", "c3", "c4",
        "c5"]].to_dict("records"))

    #with open(f"../../dashboard/json/{output_name}.json", "w") as file:
        #file.write(f"{json_final_result}")
