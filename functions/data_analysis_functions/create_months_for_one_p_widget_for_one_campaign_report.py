...
def create_months_for_one_p_widget_for_one_campaign_report(p_widget_id,
        campaign_id):

    with open(f'{os.environ.get("ULANMEDIAAPP")}/data/months_for_one_p_widget_for_one_campaign/{p_widget_id}_{campaign_id}_months_for_one_p_widget_for_one_campaign_dataset.json', 'r') as file:
        data = json.load(file)
