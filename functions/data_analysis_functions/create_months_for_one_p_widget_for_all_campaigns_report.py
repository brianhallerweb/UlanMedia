...
def create_months_for_one_p_widget_for_all_campaigns_report(p_widget_id):

    with open(f'{os.environ.get("ULANMEDIAAPP")}/data/months_for_one_p_widget_for_all_campaigns/{p_widget_id}_months_for_one_p_widget_for_all_campaigns_dataset.json', 'r') as file:
        data = json.load(file)
