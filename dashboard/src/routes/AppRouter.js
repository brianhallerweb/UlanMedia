...
import days_for_one_campaignRecords from "../components/days_for_one_campaign/Records";
  ...
  <BrowserRouter>
    <div>
      <Switch>
        ...
        <Route path="/campaign/days/:volid" component={days_for_one_campaignRecords} />
