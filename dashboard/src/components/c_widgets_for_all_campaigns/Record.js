      ...
      <tr
        ...
        <td>
          ...
          <div>
            ...
            <div className="rowLink">
              <a
                href={`https://panel.voluum.com/?clientId=7f44bde0-bb64-410b-b72c-6579c9683de0#/7f44bde0-bb64-410b-b72c-6579c9683de0_27e1fe2c-3a24-4946-b334-8e7df1b50e2d/report/month,custom-variable-1?dateRange=custom-date&sortKey=visits&sortDirection=desc&page=1&chart=0&columns=month&columns=customVariable1&columns=visits&columns=suspiciousVisitsPercentage&columns=conversions&columns=revenue&columns=cost&columns=profit&columns=cpv&columns=cv&columns=roi&columns=epv&filter=${
                  this.props.widgetRecord.widget_id
                }&limit=1000&reportType=table&include=ACTIVE&reportDataType=0&tagsGrouping=month&valueFiltersGrouping=month&from=${
                  this.props.volRequestStartDate
                }T00:00:00Z&to=${
                  this.props.volRequestEndDate
                }T00:00:00Z&filter1=traffic-source&filter1Value=37bbd390-ed90-4978-9066-09affa682bcc`}
                target="_blank">
                months
              </a>
            </div>
